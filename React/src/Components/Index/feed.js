    ...
    const feed_item_jsx = (new_post) => {
        ...
        return (
            ...
            <div className="feed-post">
                ...
                {/* <img className="feed-body" src={require(`${process.env.REACT_APP_POSTS_API}${new_post.post_file_name}`)} /> */}
                {/* <img className="feed-body" src="${process.env.REACT_APP_POSTS_API}${new_post.post_file_name}" /> */}
                <img className="feed-body" src={process.env.REACT_APP_POSTS_API + new_post.post_file_name} />
